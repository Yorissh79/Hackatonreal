...
const Home = () => {
  return (
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-6 text-center relative z-10">
          ...
          <p className="text-white text-2xl font-normal max-w-2xl leading-relaxed drop-shadow-md">
            Found in the most fascinating places on the planet, our exceptional
            one-off resorts set the stage for an extraordinary escape.
          </p>
        </div>
      </section>
      ...
      <section className="w-full flex items-center justify-center my-8 bg-white dark:bg-gray-900">
        <div className="flex flex-col w-4/5 h-60">
          ...
          <p className="text-xl text-center max-w-5xl mx-auto mt-6 text-gray-800 dark:text-gray-200">
            Lose yourself among ancient city laneways. Find yourself in dramatic
            mountain landscapes. Dive deep into the world's most fascinating
            destinations as you delight in exceptional one-off moments that take
            your breath away.
          </p>
        </div>
      </section>
      ...
      {/* About Us Section */}
      <section className="w-full flex items-center justify-center py-20 bg-gray-50 dark:bg-gray-800">
        <div className="w-4/5 max-w-6xl flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            <h2 className="text-4xl font-semibold text-gray-900 dark:text-white mb-6">
              About Us
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              At One & Only Resorts, we believe that every journey should be
              exceptional. Founded on a passion for discovery and unparalleled
              service, we craft unique escapes in some of the most breathtaking
              locations around the world.
            </p>
            <p className="mt-4 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              Our dedicated team ensures that each moment is filled with
              comfort, authenticity, and unforgettable memories. Join us and
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <p className="text-xl max-w-2xl text-center text-white drop-shadow-md">
              Discover the people and details that bring each captivating
              destination to life, as passionate locals unlock the secrets and
              stories of our captivating resorts
            </p>
            ...
            <div key={index} className="w-[32%] mb-16 group">
              ...
              <div className="flex flex-col items-start gap-7 mt-7">
                ...
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  Discover extraordinary experiences in breathtaking locations.
                  Each destination offers unique adventures and unforgettable
                  moments that will create lasting memories of your journey with
                  us.
                </p>
